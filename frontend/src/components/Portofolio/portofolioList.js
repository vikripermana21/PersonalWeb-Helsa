            ...
            <div className="flex justify-center items-center p-2">
              <div className="bg-white rounded-lg shadow-lg p-6 m-4 w-10/12 h-auto">
                <div className="flex justify-end items-center p-2 mb-4">
                  <AiOutlinePlusCircle
                    size={25}
                    onClick={redirectToAddPortofolio}
                    className="mr-2"
                ...
                <table className="table-auto w-full">
                  <thead>
                    <tr>
                      <th className="border px-4 py-2 w-4/12">
                        Nama Portofolio
                      </th>
                      <th className="border px-4 py-2 w-4/12">
                    ...
                    {portofolios.map((portofolio) => (
                      <tr key={portofolio.id_portofolio}>
                        ...
                        <td className="border px-4 py-2 text-center">
                          <button
                            className="btn btn-sm btn-info inline-block"
                            style={{
                              backgroundColor: "#3876BF",
                              color: "#fff",
                            }}
                            onClick={() =>
                              redirectToPortofolioDetails(
                          ...
                          <button
                            ...
                            onClick={() =>
                              redirectToEditPortofolio(portofolio.id_portofolio)
                            }
                          >
                            Edit
                          </button>
                          <button
                            ...
                            onClick={() =>
                              deletePortoHandler(portofolio.id_portofolio)
                            }
                          >
                            Delete
                          </button>
